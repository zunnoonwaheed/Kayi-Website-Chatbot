...
export default function ReviewSection() {
  ...
  return (
    <section className="py-20 px-6 relative overflow-hidden">
      {/* Gradient Background - Exact copy from FAQ section */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        {/* Heading - Made slightly smaller but still bold */}
        <motion.div
          ...
          >
            {reviews.map((review, index) => (
              ...
              >
                {/* Media */}
                <div
                  className="relative h-[420px] w-full lg:h-full group cursor-pointer"
                ...
                >
                  ...
                  {review.video && paused[index] && (
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="bg-white/40 rounded-full p-4 backdrop-blur-sm hover:bg-white/60 transition">
