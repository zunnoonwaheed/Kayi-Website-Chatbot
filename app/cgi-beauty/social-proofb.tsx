...
const SocialProof = () => {
  const clients = [
    ...
    },
    {
      ...
      earnings: "$643,089.00",
      campaign: "Educational Series Campaign",
      color: "#C0C0C0"
    },
    {
      rank: 3,
  ...
  return (
    <div className="bg-white py-12 md:py-20 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <span style={{ color: '#CF21C3' }}>$2.4M In Brand Revenue</span>
          <br />
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 md:mb-8 pb-4 md:pb-6 border-b border-gray-200 gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-gray-900 font-semibold text-base md:text-lg">Beauty Results</h3>
        ...
        >
          These beauty brands partnered with us and generated{" "}
          <span className="font-bold text-gray-900">over $2.4 million in tracked sales</span>{" "}
          in under 90 days using CGI ads that make products look premium and convert impulse browsers into buyers.
        </motion.p>
