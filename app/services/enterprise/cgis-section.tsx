...
const FinancialPotentialSection = () => {
  ...
  return (
    <section className="py-12 lg:py-24 px-4 sm:px-6 relative overflow-hidden min-h-screen flex items-center">
      ...
      <div className="absolute inset-0">
        ...
        <motion.div
          className="absolute top-1/6 left-1/6 w-64 h-64 lg:w-96 lg:h-96 bg-gradient-radial from-[#cf21c3]/15 via-pink-500/10 to-transparent rounded-full blur-3xl"
          animate={{ scale: [1, 1.4, 1], opacity: [0.5, 0.8, 0.5], x: [0, 60, 0], y: [0, -40, 0], rotate: [0, 180, 360] }}
          transition={{ duration: 20, repeat: Number.POSITIVE_INFINITY, ease: "easeInOut" }}
        />
        <motion.div
          className="absolute bottom-1/6 right-1/6 w-80 h-80 lg:w-[32rem] lg:h-[32rem] bg-gradient-radial from-pink-500/12 via-[#cf21c3]/8 to-transparent rounded-full blur-3xl"
